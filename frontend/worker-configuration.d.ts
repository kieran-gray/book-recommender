/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7dc3ac0bd0e963759011ebe154b07b44)
// Runtime types generated with workerd@1.20260426.1 2026-04-24 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface DevEnv {
		ASSETS: Fetcher;
		CLOUDFLARE_RAG_INGEST_API_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		BLOG_POST_QA_CACHE_KV_NAMESPACE_ID: string;
		BACKEND: Fetcher /* jess-book-recommender-backend-dev */;
	}
	interface Env {
		ASSETS: Fetcher;
		CLOUDFLARE_RAG_INGEST_API_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		BLOG_POST_QA_CACHE_KV_NAMESPACE_ID: string;
		BACKEND: Fetcher /* jess-book-recommender-backend-dev */ | Fetcher /* jess-book-recommender-backend */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_RAG_INGEST_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "BLOG_POST_QA_CACHE_KV_NAMESPACE_ID">> {}
}
